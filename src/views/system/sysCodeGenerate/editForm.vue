...
<script>
  import { codeGenerateInformationList, codeGenerateEdit } from '@/api/modular/system/sysCodeGenerateManage'
    ...
    methods: {
      ...
      generateTypeRadio (generateType) {
        if (generateType === '1') {
          ...
          this.form.setFieldsValue({ authorName: 'young-pastor' })
          this.form.setFieldsValue({ packageName: 'com.zhisida.board' })
        }
      }
    }
  }
